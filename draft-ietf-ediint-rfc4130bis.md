...
docname: draft-ietf-ediint-rfc4130bis-latest
...
#  arch: https://example.com/WG
  github: "DrummondGroup/draft-ietf-ediint-rfc4130bis"
  latest: "https://DrummondGroup.github.io/draft-ietf-ediint-rfc4130bis/draft-ietf-ediint-rfc4130bis.html"
...
extend the use of weak algorithms used by [RFC4130] implementations.
...
## Hash Algorithms
   ...
   SHA-384 or stronger algorithms.
...
### Multiple-Recipient Encryption
   ...
   See Section 1.2.1 for guidance on handling weak algorithms when interoperating
   with legacy AS2 systems.
...
# Public Key Certificate Handling {#public-key-certificate-handling}
   ...
   supported mechanisms such as Well-Known URIs [RFC8615]
   (see {{certificate-exchange-and-renewal}}).
...
## Certificate Exchange and Renewal {#certificate-exchange-and-renewal}
   ...
   The Well-Known URI [RFC8615] MAY be used for initial retrieval of partner
...
# Security Considerations {#security-considerations}
   ...
   Legacy algorithms SHOULD NOT be generated in modern implementations.
   However, legacy use cases may still be encountered when interoperating
   with older systems conforming to [RFC4130]. See Section 1.2.1 for
   clarifications on legacy interoperability.
   ...
   Well-Known URIs [RFC8615], see {{public-key-certificate-handling}} and
...
##  AS2 MDN Disposition Modifier Registry
   ...
   **Initial Registry Contents:**
   ...
   |-----------------------------------------|------------------|
   | error: authentication-failed            | [RFC-to-be]      |
   | error: decompression-failed             | [RFC-to-be]      |
   | error: decryption-failed                | [RFC-to-be]      |
   | error: insufficient-message-security    | [RFC-to-be]      |
   | error: integrity-check-failed           | [RFC-to-be]      |
   | error: unexpected-processing-error      | [RFC-to-be]      |
   | error:duplicate-filename                | [RFC-to-be]      |
   | error:illegal-filename                  | [RFC-to-be]      |
   | error:invalid-message-id                | [RFC-to-be]      |
   | error:unknown-trading-relationship      | [RFC-to-be]      |
   | error:unknown-trading-partner           | [RFC-to-be]      |
...
- Clarified semantics for signed-receipt-micalg:
  ...
  * SHA-256 set as the default minimum
...
- Revised the opening paragraph to reference the optional Well-Known URIs as
...
- **UPDATED (Technical Review)**: Clarified Well-Known URIs certificate retrieval
